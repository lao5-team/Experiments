...
;(function( $, window, document, undefined ) {
    ...
    Waterfall.prototype = {
        ...
        _requestData: function(callback) {
            ...
            var getCollectionInfo = function (worksIdList) {
                $.ajax({
                    type: 'POST',
                    url: tumAppInst.options.hostName + 'collect/works/iscollect',
                    data: JSON.stringify(worksIdList),
                    headers: headers,
                    dataType: dataType,
                    ...
                    success: function(data) {
                        $.each(worksList.results, function (index, value) {
                            value.isCollect = tumAppInst.findEleInArray(data, 'id', value.id).isCollect;
                        });
                        getLikeInfo(worksIdList);
                    },
            ...
            var getLikeInfo = function (worksIdList) {
                $.ajax({
                    type: 'POST',
                    url: tumAppInst.options.hostName + 'like/works/islike',
                    data: JSON.stringify(worksIdList),
                    headers: headers,
                    dataType: dataType,
                    contentType: 'application/json',
                    ...
                    success: function(data) {
                        $.each(worksList.results, function (index, value) {
                            value.isLike = tumAppInst.findEleInArray(data, 'id', value.id).isLike;
                        });
                        self._handleResponse(worksList, callback);
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $.each(data.results, function (index, value) {
                        ...
                        worksIdList.push(value.id);
                    });

                    getCollectionInfo(worksIdList);
                },
                error: function(jqXHR) {
                    self._responeseError('error');
                }
